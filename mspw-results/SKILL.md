...
- `mspw-user-study`: 仮説の番号と Results の supported/not supported の対応
- `mspw-discussion`: Resultsでは事実のみ、解釈は Discussion に分離
- `mspw-writing-principles`: 比較対象の明示、曖昧な最上級の回避
