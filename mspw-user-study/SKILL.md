...
- `mspw-method`: System章と User Study章の独立変数の定義は完全に一致させる
- `mspw-results`: 仮説と結果は1対1で対応させる
- `mspw-writing-principles`: 曖昧な最上級の回避
